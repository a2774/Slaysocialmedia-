...
const Profile = () => {
  ...
  const { domain: domainName, uuid, section } = query;
  ...
  // Determine the selected option from the query parameter or default to 'option1'
  const selectedOption = section || 'option1';
        ...
        <Box
          ...
          {selectedOption === 'option1' && pathname === '/profile' && (
            <Box component='form' onSubmit={handleSubmit} sx={{ padding: { xs: '16px', md: '24px' } }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' } }}>
                <Box sx={{ display: 'flex', width: '100%', marginRight: '20px' }}>
                  <TextField
                    select
                    margin='normal'
                    name='countryCode'
                ...
                <TextField
                  ...
                  style={{ backgroundColor: '#465A7E66', borderRadius: '8px', cursor: 'pointer' }}
                  InputProps={{ style: { color: 'white' } }}
